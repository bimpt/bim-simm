    ...
    <div class="item form-group align-items-center {{ ($data->jenis == 'image' ? 'd-inline' : 'd-none') }}">
        ...
        <div class="col-md-12 col-sm-6 ">
            ...
            @elseif($data->jenis == 'image')
                <div class="row align-items-center justify-content-center">
                    <img src="{{ asset('/themes/img/pengaturan-aplikasi/'.str_replace('_', '-', $data->key ).'.png') }}" class="{{ str_replace('_', '-', $data->key ) }}-preview img-fluid mb-3 col-md-12 col-sm-6">
                </div>
            @endif
            ...
            <div class="text-center">
                <button class="btn btn-dark" id="files" onclick="document.getElementById('{{ $data->key }}').click(); return false;">Ubah Gambar</button>
...
<script>
    ...
    function previewLogo(){
        const photo = document.querySelector('#logo');
        const photoPreview = document.querySelector('.logo-preview');
