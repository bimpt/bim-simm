...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['permissions'], function (Blueprint $table) {
            ...
            $table->bigInteger('parent_id')->nullable(); // For MySQL 8.0 use string('guard_name', 125);
            $table->string('name');       // For MySQL 8.0 use string('name', 125);
            $table->string('label');       // For MySQL 8.0 use string('label', 125);
            $table->string('module');       // For MySQL 8.0 use string('module', 125);
            $table->string('code');       // For MySQL 8.0 use string('name', 125);
